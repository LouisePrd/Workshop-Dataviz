...
var _experience = require("./scripts/experience");

},{"./styles/main.scss":"bo7w8","./scripts/experience":"9qLvk"}],"bo7w8":[function() {},{}],"9qLvk":[function(require,module,exports) {
...
function initPaper() {
    console.log((0, _paperDefault.default));
    let path = new (0, _paperDefault.default).Path();
    path.strokeColor = "black";
    path.add(new Point(30, 30));
    path.add(new Point(100, 100));
    const paperCanvas = document.getElementById("#visualizer");
    const project = new (0, _paperDefault.default).Project(paperCanvas);
}
...
},{}]},["7Aums","bNKaB"], "bNKaB", "parcelRequireaebf")
